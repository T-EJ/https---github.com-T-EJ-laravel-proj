...
<a href="/myproduct" class="back" >Continue Shopping</a>
      <center>  
    <table  style="width:60%;box-shadow:5px 15px 30px grey;margin-top:120px;">
        ...
        @php $total=0;@endphp
            ...
            @endphp
                <tr>
                <td><img src="{{$product['img']}}"  width='200px'></td>
                    <td>{{$product['name']}}</td>
                    <td>{{$product['price']}}</td>
